 ...
 * @param <M> 适配的数据类型
 */
public abstract class CHZZRecyclerViewAdapter<M> extends RecyclerView.Adapter<CHZZRecyclerViewHolder> {
    ...
    public CHZZRecyclerViewAdapter(RecyclerView recyclerView, int itemLayoutId) {
     ...
     * @param model
     */
    protected abstract void fillData(CHZZViewHolderHelper viewHolderHelper, int position, M model);
