 ...
 * 描述:
 */
public class CHZZBadgeLinearLayout extends LinearLayout implements CHZZBadgeable {
    private CHZZBadgeViewHelper mBadgeViewHeler;

    public CHZZBadgeLinearLayout(Context context) {
        this(context, null);
    }

    public CHZZBadgeLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
