 ...
 */
public class CHZZExplosionAnimator extends ValueAnimator {
    ...
    private CHZZDragBadgeView mDragBadgeView;
    private Rect mRect;
    private Rect mInvalidateRect;

    public CHZZExplosionAnimator(CHZZDragBadgeView dragBadgeView, Rect rect, Bitmap bitmap) {
        setFloatValues(0.0f, END_VALUE);
        setDuration(ANIM_DURATION);
        setInterpolator(DEFAULT_INTERPOLATOR);

        X = CHZZBadgeViewUtil.dp2px(dragBadgeView.getContext(), 5);
        Y = CHZZBadgeViewUtil.dp2px(dragBadgeView.getContext(), 20);
        V = CHZZBadgeViewUtil.dp2px(dragBadgeView.getContext(), 2);
        W = CHZZBadgeViewUtil.dp2px(dragBadgeView.getContext(), 1);
