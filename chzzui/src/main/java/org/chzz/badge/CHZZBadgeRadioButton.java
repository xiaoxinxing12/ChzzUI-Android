 ...
 * 描述:
 */
public class CHZZBadgeRadioButton extends RadioButton implements CHZZBadgeable {
    private CHZZBadgeViewHelper mBadgeViewHeler;

    public CHZZBadgeRadioButton(Context context) {
        this(context, null);
    }

    public CHZZBadgeRadioButton(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.radioButtonStyle);
    }

    public CHZZBadgeRadioButton(Context context, AttributeSet attrs, int defStyleAttr) {
