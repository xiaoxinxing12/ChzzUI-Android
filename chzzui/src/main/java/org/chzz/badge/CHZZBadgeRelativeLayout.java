 ...
 * 描述:
 */
public class CHZZBadgeRelativeLayout extends RelativeLayout implements CHZZBadgeable {
    private CHZZBadgeViewHelper mBadgeViewHeler;

    public CHZZBadgeRelativeLayout(Context context) {
        this(context, null);
    }

    public CHZZBadgeRelativeLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CHZZBadgeRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
