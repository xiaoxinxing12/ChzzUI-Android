 ...
 * 描述:
 */
public class CHZZBadgeViewUtil {

    private CHZZBadgeViewUtil() {
    }
    ...
    public static Bitmap createBitmapSafely(CHZZDragBadgeView dragBadgeView, Rect rect, int retryCount) {
        try {
