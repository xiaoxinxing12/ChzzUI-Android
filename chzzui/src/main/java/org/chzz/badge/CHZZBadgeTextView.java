 ...
 * 描述:
 */
public class CHZZBadgeTextView extends TextView implements CHZZBadgeable {
    private CHZZBadgeViewHelper mBadgeViewHeler;

    public CHZZBadgeTextView(Context context) {
        this(context, null);
    }

    public CHZZBadgeTextView(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.textViewStyle);
    }

    public CHZZBadgeTextView(Context context, AttributeSet attrs, int defStyleAttr) {
