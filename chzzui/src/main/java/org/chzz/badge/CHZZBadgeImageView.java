 ...
 * 描述:
 */
public class CHZZBadgeImageView extends ImageView implements CHZZBadgeable {
    private CHZZBadgeViewHelper mBadgeViewHeler;

    public CHZZBadgeImageView(Context context) {
        this(context, null);
    }

    public CHZZBadgeImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CHZZBadgeImageView(Context context, AttributeSet attrs, int defStyleAttr) {
