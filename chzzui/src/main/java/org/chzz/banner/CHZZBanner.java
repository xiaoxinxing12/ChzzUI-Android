...
import org.chzz.R;
import org.chzz.banner.transformer.AccordionPageTransformer;
import org.chzz.banner.transformer.AlphaPageTransformer;
import org.chzz.banner.transformer.CubePageTransformer;
import org.chzz.banner.transformer.DefaultPageTransformer;
import org.chzz.banner.transformer.DepthPageTransformer;
import org.chzz.banner.transformer.FadePageTransformer;
import org.chzz.banner.transformer.FlipPageTransformer;
import org.chzz.banner.transformer.RotatePageTransformer;
import org.chzz.banner.transformer.StackPageTransformer;
import org.chzz.banner.transformer.ZoomCenterPageTransformer;
import org.chzz.banner.transformer.ZoomFadePageTransformer;
import org.chzz.banner.transformer.ZoomPageTransformer;
import org.chzz.banner.transformer.ZoomStackPageTransformer;

import java.util.List;


public class CHZZBanner extends RelativeLayout {
    private static final String TAG = CHZZBanner.class.getSimpleName();
    ...
    private int mPointDrawableResId = R.drawable.selector_chzzbanner_point;
    ...
    private void initDefaultAttrs(Context context) {
        mViewPager = new CHZZViewPager(context);
    ...
    private void initCustomAttr(int attr, TypedArray typedArray) {
        if (attr == R.styleable.CHZZBanner_banner_pointDrawable) {
            mPointDrawableResId = typedArray.getResourceId(attr, R.drawable.selector_chzzbanner_point);
        ...
        } else if (attr == R.styleable.CHZZBanner_banner_pointGravity) {
    ...
    private final class ChangePointListener extends CHZZViewPager.SimpleOnPageChangeListener {
