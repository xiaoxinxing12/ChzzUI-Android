 ...
 *          类说明
 */
public class CHZZPickerView extends View {
    ...
    **/
    ...
    public CHZZPickerView(Context context) {
        super(context);
        init();
    }

    public CHZZPickerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
            ...
            case MotionEvent.ACTION_UP:
                ...
                if ((System.currentTimeMillis() - exitTime) > 100) {
                    ...
                    if (mClickListener != null && mDataList.size() != 0)
                        mClickListener.onClick(mDataList.get(mCurrentSelected));
